<?php 
	trait ProductsModel{
		...
		public function modelUpdate($id){
			...
			$conn->query("update products set name='$name',description='$description',content='$content',hot=$hot,price=$price,beforeprice=$beforeprice,brand='$brand',origin='$origin',volume='$volume',discount=$discount,category_id=$category_id where id=$id");
		...
		public function modelCreate(){
			...
			$discount=0;
			$beforeprice = $_POST["beforeprice"];
			// if ($_POST["beforeprice"]!= "") $beforeprice=$_POST["beforeprice"]; else $beforeprice=$_POST["price"];
			$description = $_POST["description"];
			$content = $_POST["content"];
			$hot = isset($_POST["hot"]) ? 1 : 0;
			$photo = "";
			...
			$conn = Connection::getInstance();
			//update du lieu tuong ung voi id truyen vao
			// $conn->query("insert into products set name='$name',description='$description',content='$content',hot=$hot,photo='$photo',photo1='$photo1',photo2='$photo2',photo3='$photo3',photo4='$photo4',photo5='$photo5',price=$price,beforeprice=$beforeprice,brand='$brand',discount=$discount,category_id=$category_id");
			$conn->query("insert into products set name='$name',description='$description',content='$content',hot=$hot,photo='$photo',photo1='$photo1',photo2='$photo2',photo3='$photo3',photo4='$photo4',photo5='$photo5',price=$price,beforeprice=$beforeprice,brand='$brand',discount=$discount,category_id=$category_id,origin='$origin',volume='$volume' where id=$id");
