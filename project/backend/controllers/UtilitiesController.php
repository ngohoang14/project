<?php 
	//include file model 
	include "models/UtilitiesModel.php";
	class UtilitiesController extends Controller{
		...
		public function index(){
			...
			$this->loadView("UtilitiesView.php",["data"=>$data,"numPage"=>$numPage]);
		}
		...
		public function update(){
			...
			$action = "index.php?controller=utilities&action=updatePost&id=$id";
			//goi view, truyen du lieu ra view
			$this->loadView("UtilitiesFormView.php",["record"=>$record,"action"=>$action]);
		}
		...
		public function updatePost(){
			...
			//di chuyen den url
			header("location:index.php?controller=utilities");
		}
		//create ban ghi - trang thai GET
		public function create(){
			//tao bien $action de dua vao thuoc tinh action cua form
			$action = "index.php?controller=utilities&action=createPost";
			//goi view, truyen du lieu ra view
			$this->loadView("UtilitiesFormView.php",["action"=>$action]);
		}
