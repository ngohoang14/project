<?php 
	...
	class ContactController extends Controller{
		...
		public function update(){
			...
			$action = "index.php?controller=contact&action=updatePost&id=$id";
			//goi view, truyen du lieu ra view
			$this->loadView("ContactFormView.php",["record"=>$record,"action"=>$action]);
		}
		...
		public function create(){
			...
			//goi view, truyen du lieu ra view
			$this->loadView("ContactFormView.php",["action"=>$action]);
		}
