<?php 
	...
	class SevicesController extends Controller{
		...
		public function update(){
			...
			$action = "index.php?controller=sevices&action=updatePost&id=$id";
			//goi view, truyen du lieu ra view
			$this->loadView("SevicesFormView.php",["record"=>$record,"action"=>$action]);
		}
		...
		public function updatePost(){
			...
			//di chuyen den url
			header("location:index.php?controller=sevices");
		}
		...
		public function create(){
			...
			//goi view, truyen du lieu ra view
			$this->loadView("SevicesFormView.php",["action"=>$action]);
		}
