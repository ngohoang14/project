    ...
    <div class="panel panel-primary">
        ...
        <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="<?php echo isset($record->brand) ? $record->brand:''; ?>" name="brand" class="form-control" required>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
            ...
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2">Before price</div>
                <div class="col-md-10">
                    <input type="number" value="<?php echo isset($record->beforeprice) ? $record->beforeprice:''; ?>" min="0" step="0.01" name="beforeprice" class="form-control">
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="text" value="<?php echo isset($record->origin) ? $record->origin:''; ?>" name="origin" class="form-control" required>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2">Thể tích</div>
                <div class="col-md-10">
                    <input type="number" value="<?php echo isset($record->volume) ? $record->volume:''; ?>" name="volume" class="form-control" required>
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
